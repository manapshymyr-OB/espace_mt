...
X_train, X_test, y_train, y_test = train_test_split(features, category_label, test_size=0.2, random_state=42)
...
# SVC is recommended for multiclass
svc = LinearSVC(C=4, max_iter=1000, loss='hinge', verbose=1, )
